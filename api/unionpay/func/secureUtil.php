<?php
include_once ROOT_PWC.'api/unionpay/func/SDKConfig.php';
include_once ROOT_PWC.'api/unionpay/func/PublicEncrypte.php';
include_once ROOT_PWC.'api/unionpay/func/common.php';
include_once ROOT_PWC.'api/unionpay/func/log.class.php';
 ...
 * @param String $signature_str  
 modify by lufeng 此方法与系统函数方法重名了
 */
function verify_unionpay($params) {
	global $log;
	// 公钥
